...
RUN pip install minio requests python-dotenv kafka-python confluent_kafka
...
RUN mvn dependency:get -Dartifact=org.apache.iceberg:iceberg-spark-runtime-3.5_2.13:1.8.1 && \ 
    ...
    mvn dependency:get -Dartifact=org.apache.spark:spark-sql-kafka-0-10_2.13:3.5.5 && \
